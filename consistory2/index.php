...
<p>If you already have been approved, please go to the <a href="http://' . $_SERVER['HTTP_HOST'] . SITE_PREFIX . 'login.php">login form</a> to enter the database.</p><p>cedarapps</p>
';
